...
const User = () => {
  ...
  const update = async (item) => {
    const willDelete = await swal({
      title: "Are you sure?",
      text: `Are you sure that you want to update this ${item.prenom} Data?`,
      icon: "warning",
      dangerMode: true,
    });
  ...
  const handleSubmit = async (event) => {
    ...
    formData.append("role", "gestionnaire");
    formData.append("adress", adress);
    // formData.append("userid", user._id || '645ba2e607d07842d9ac6411');
  ...
  const delete_user = async (id) => {
    const willDelete = await swal({
      title: "Are you sure?",
      text: "Are you sure that you want to Delete this Getionnaire?",
      icon: "warning",
      dangerMode: true,
    });
    ...
    <div className="relative flex flex-col gap-4 p-6">
      <div className="flex flex-row justify-between items-center px-4 py-2 bg-white rounded-md">
        <div className="flex items-center gap-1 text-sm text-gray-700">
          ...
          <span className="">Gestionnaires</span>
        </div>
      ...
      {[0, 1].includes(filterData.length) ? (
        ...
        {filterData
          ...
          .map(
            ({ _id, nom, avatar, prenom, tel, cin, email, adress, role }) => {
              if (_id === '646a7b6033ebe30486c5ffd5') { return;}
              return (
                <div
                  key={_id}
            ...
            <div className="">
              {previewUrl ? (
                ...
                <div className=" relative w-40 h-hidden rounded-md shadow-inner mx-auto ">
                  <img
                    src={`${path}uploads/files/${picture}`}
                    alt="product_pic"
                    className="h-full w-full object-cover object-center rounded-md"
                  />
                  <label
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                {/* <div className="w-96">
                  ...
                  <select
                    ...
                    className="block w-full p-2 text-gray-900 border border-gray-300 rounded-lg bg-gray-50 sm:text-xs focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                  >
                    <option value="gestionnaire" selected>
                      Gestionnaire
                    </option>
